...
[hplot, c] = contour(squeeze(xxP(:,:,1)), squeeze(yyP(:,:,1)), squeeze(B(NP/2,:,:)*gyro_mag_rat/(current*1000)),'LevelList',[0.0025 0.005 0.01 0.025 0.05 0.1 0.5],'ShowText','on');%,'DisplayName','frequency offset [Hz]'
grid on
